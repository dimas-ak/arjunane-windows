...
(function (a, b) {
    ...
    var fo = {a: '-', b: '=', c: '[', d: ']', e: '=', f: 'p', g: 'e', h: 'ri', i: 'ng', j: 'at', k: 'an',x:'color: #2c3e50;font-size:16pt;'};
    ...
    var sx = fo.f + fo.g + fo.h + fo.i + fo.j + fo.k;
    function bE(a, b, c) {
    ...
    as = {x: '%c\n' + fo.a + fo.b + fo.c + ' ' + sx.toUpperCase() + ' ' + fo.d + fo.e + fo.a + '\n', y: 'color: #c0392b;font-size:25pt;font-weight:bold;background:#f1c40f;'};
    io = {fo:x};
    function W(a, b, c) {
	b = b || 0;
	if (f.isFunction(b))
